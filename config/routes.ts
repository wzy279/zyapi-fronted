export default [
  ...
  { name: '查看接口', path: '/InterfaceInfo/:id', icon: 'smile', component: './InterfaceInfo',hideInMenu:true },
  { name: '查看对话', path: '/ModelMessage/:id/:name', icon: 'smile', component: './AIMessage',hideInMenu:true },
  {
    path: '/admin',
    icon: 'crown',
    access: 'canAdmin',
    ...
    routes: [
      ...
      {path: '/admin/userInterfacelist',component: './Admin/UserInterfaceList',name:'调用管理'}
    ],
  },
