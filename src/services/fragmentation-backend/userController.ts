...
/** changPassByEmail POST /api/user/changePassBYEmail */
export async function changPassByEmailUsingPOST(
  body: API.UserChangePassRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseboolean>('/api/user/changePassBYEmail', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** userLoginByEmailGetCode GET /api/user/emailCode */
export async function userLoginByEmailGetCodeUsingGET(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.userLoginByEmailGetCodeUsingGETParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseboolean>('/api/user/emailCode', {
    method: 'GET',
    params: {
      ...params,
    },
...
/** userLoginBYAccount POST /api/user/login/account */
export async function userLoginBYAccountUsingPOST(
  body: API.UserLoginRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseLoginUserVO>('/api/user/login/account', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
